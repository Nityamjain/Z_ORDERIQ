CLASS zcl_auxiliary_nro DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PROTECTED SECTION.
  PRIVATE SECTION.
    CONSTANTS c_object    TYPE cl_numberrange_objects=>nr_attributes-object   VALUE 'ZSO_NRO'.
  ...
  METHOD create_number_range.
    TRY.
        cl_numberrange_intervals=>create(
          EXPORTING interval  = VALUE #( ( nrrangenr = '01' fromnumber = '0' tonumber = '9' procind = 'I' ) )
                    object    = c_object
